...
void Triangle::render()
{
	...
	TextRendering::Instance()->draw("Buttons: 1,2,3,4 = controls Fred's head", glm::vec3(0.1f, 1.0f, 0.0f), text_matrix_2D * translate_2d_text * scale_2d_text);
	...
	// text 3D 
	TextRendering::Instance()->draw("Fred", glm::vec3(0.1f, 1.0f, 0.0f), text_matrix_3D_model_1);
	TextRendering::Instance()->draw("Bob", glm::vec3(0.1f, 1.0f, 0.0f), text_matrix_3D_model_2);
